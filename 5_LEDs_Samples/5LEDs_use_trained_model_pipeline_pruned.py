...
Y_presence_train = (Y_train != 0)
Y_presence_test = (Y_test != 0)
# print(Y_train)
# print(Y_presence_train)
presence_pipe = pipeline.Pipeline([('svc', svm.SVC(gamma='auto', kernel='linear', probability=True), )])
presence_pipe.fit(X_train, Y_presence_train)
...
print(presence_pipe.score(X_test, Y_test))
print(presence_pipe.predict_proba(X_test))
print(presence_pipe.predict(X_test))
print()
